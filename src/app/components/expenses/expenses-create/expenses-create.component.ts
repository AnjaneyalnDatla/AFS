...
export class ExpensesCreateComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if (this.userDetails != null) {
      this.expenseForm.controls["user_id"].setValue(
        this.userDetails["attributes"]['userId'][0]
      );
      this.expenseForm.controls["user_name"].setValue(
        this.userDetails["username"]
      );
      this.expenseForm.controls["departmentId"].setValue(
        this.userDetails["attributes"]['departmentId'][0]
      );
      this.expenseForm.controls["departmentName"].setValue(
    ...
    const myFormValueChanges$ = this.expenseForm.controls['lineItems'].valueChanges;
  ...
  get productInfoForms() {
    return this.expenseForm.get('lineItems') as FormArray;
  }
  ...
  addNewProduct() {
    const control = <FormArray>this.expenseForm.controls['lineItems'];
